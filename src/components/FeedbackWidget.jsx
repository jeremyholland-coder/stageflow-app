  ...
  return (
    <>
      ...
      <button
        ...
        className="hidden sm:flex fixed top-1/2 right-0 -translate-y-1/2 bg-gradient-to-br from-gray-800 to-gray-900 hover:from-gray-700 hover:to-gray-800 text-white px-3 py-4 sm:py-6 rounded-l-xl shadow-lg hover:shadow-xl border-l border-t border-b border-teal-500/30 z-[160] group flex-col items-center transition-all duration-200"
        style={{
      ...
      <button
        onClick={() => setIsOpen(true)}
        className="sm:hidden fixed bottom-6 right-6 bg-teal-500 hover:bg-teal-600 text-white p-4 rounded-full shadow-lg shadow-teal-500/20 hover:shadow-teal-500/40 z-[160] hover:scale-110 active:scale-95 transition-all duration-200"
        style={{
          minWidth: '56px',
          minHeight: '56px'
        }}
